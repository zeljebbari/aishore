...
def upload_file():
    ...
    if file: 
        ...
        return (
            f"File uploaded successfully!<br><br>"
            f"Entity Name: {entity}<br>"
            f"Borrower Name: {borrower}<br>"
            f"Document Type: {doc_type}<br>"
            f"Timestamp: {timestamp}"
            f"Filename in Cloud: NA TEMP -- {entity}_{doc_type}"
        )
